...
DevelopedLot::DevelopedLot(double latitude, double longitude, double width, double length, double floor_area, int num_floors):
    Lot(latitude, longitude, width,length),
